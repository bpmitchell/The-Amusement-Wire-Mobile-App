(function(l){l.fn.rssfeed=function(d,h,v){h=l.extend({limit:10,offset:1,header:false,titletag:"h4",date:false,dateformat:"datetime",content:!0,snippet:false,media:!0,showerror:!0,errormsg:"",key:null,ssl:!1,linktarget:"false",linkredirect:"false",linkcontent:!1,sort:"",sortasc:!0,historical:!1},h);return this.each(function(x,p){var t=l(p),f="";h.ssl&&(f="s");t.hasClass("rssFeed")||t.addClass("rssFeed");if(null==d)return!1;0<h.offset&&(h.offset-=1);h.limit+=h.offset;f="http"+f+"://ajax.googleapis.com/ajax/services/feed/load?v=1.0&callback=?&q="+
...
n(b.getSeconds()))}e.linkredirect&&(k=encodeURIComponent(k));i[c].html="<"+e.titletag+'><u>'+g.title+"</u></"+e.titletag+">";e.date&&a&&(i[c].html+="<div>"+a+"</div>");e.content&&(g=e.snippet&&""!=g.contentSnippet?g.contentSnippet:g.content,e.linkcontent&&(g='<a href="'+e.linkredirect+k+'" title="View this feed at '+j.title+'">'+g+"</a>"),i[c].html+="<p>"+g+"</p>");if(e.media&&0<m.length&&(k=m[f].getElementsByTagName("enclosure"),0<
